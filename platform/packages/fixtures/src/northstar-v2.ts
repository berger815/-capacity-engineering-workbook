...
export const northstarV2Model: CapacityModel = {
  ...
  supplier: {
    ...
    supplierName: "Northstar Thermal Systems",
    site: "Harbor Works",
    externalKeys: { syntheticVendorNumber: "NORTHSTAR-DEMO" },
  },
  ...
  resourceGroups: [
    { id: "rg-app", name: "Applications Engineering", organizationNodeId: "engineering", kind: "labor", capacityUnit: "hours", calendarId: "harbor-standard", pooled: true, indirect: true },
    { id: "rg-detail", name: "Detailed Engineering", organizationNodeId: "engineering", kind: "labor", capacityUnit: "hours", calendarId: "harbor-standard", pooled: true, indirect: true },
